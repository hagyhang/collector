 ...
 * @author hagyhang
 */
public class SecStatsPointHandler extends HttpServlet{
	@Override
    protected void doGet( HttpServletRequest request,
		...
		if (interval == 1){
			list = StatsPointModel.getSecStatsPoints(name, limit);
		} else {
			list = StatsPointModel.getSecStatsPoints(name, limit, interval);
		}
