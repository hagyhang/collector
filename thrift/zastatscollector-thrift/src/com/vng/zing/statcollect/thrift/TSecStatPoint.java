...
public class TSecStatPoint implements org.apache.thrift.TBase<TSecStatPoint, TSecStatPoint._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TSecStatPoint");
  ...
  static {
    schemes.put(StandardScheme.class, new TSecStatPointStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TSecStatPointTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TSecStatPoint.class, metaDataMap);
  }

  public TSecStatPoint() {
  }
   ...
   */
  public TSecStatPoint(TSecStatPoint other) {
  ...
  public TSecStatPoint deepCopy() {
    return new TSecStatPoint(this);
  }
  ...
  public TSecStatPoint setTotalReq(int totalReq) {
    this.totalReq = totalReq;
    setTotalReqIsSet(true);
    return this;
  }
  ...
  public TSecStatPoint setTotalTimeProc(long totalTimeProc) {
    this.totalTimeProc = totalTimeProc;
    setTotalTimeProcIsSet(true);
    return this;
  }
  ...
  public TSecStatPoint setTimestamp(long timestamp) {
    this.timestamp = timestamp;
    setTimestampIsSet(true);
    return this;
  }
  ...
  public TSecStatPoint setPeakTimeProc(TPeakInfo peakTimeProc) {
    this.peakTimeProc = peakTimeProc;
    return this;
  }
  ...
  public TSecStatPoint setPeakPendingReq(TPeakInfo peakPendingReq) {
    this.peakPendingReq = peakPendingReq;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TSecStatPoint)
      return this.equals((TSecStatPoint)that);
    return false;
  }

  public boolean equals(TSecStatPoint that) {
    if (that == null)
      return false;
  ...
  public int compareTo(TSecStatPoint other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    TSecStatPoint typedOther = (TSecStatPoint)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TSecStatPoint(");
    boolean first = true;
  ...
  private static class TSecStatPointStandardSchemeFactory implements SchemeFactory {
    public TSecStatPointStandardScheme getScheme() {
      return new TSecStatPointStandardScheme();
    }
  }

  private static class TSecStatPointStandardScheme extends StandardScheme<TSecStatPoint> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TSecStatPoint struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSecStatPoint struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TSecStatPointTupleSchemeFactory implements SchemeFactory {
    public TSecStatPointTupleScheme getScheme() {
      return new TSecStatPointTupleScheme();
    }
  }

  private static class TSecStatPointTupleScheme extends TupleScheme<TSecStatPoint> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TSecStatPoint struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TSecStatPoint struct) throws org.apache.thrift.TException {
